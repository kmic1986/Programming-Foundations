...
puts "This is because '<<' is a mutative operation and '+='"
puts "is a reassignment operation."
...
puts "My string looks like this now: #{my_string}"
puts "My array looks like this now: #{my_array}"
puts "Same as number 4, just reversed. '<<' is still mutative"
puts "and '+=' is still a reassignment."
